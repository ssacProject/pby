...
imagePath = home + "/OpenCV_in_Ubuntu/Data/Lane_Detection_Images/line_test4.jpg"
...
pt2 = (width*0.55, height*0.35)
pt3 = (width, height*1.0)
pt4 = (0, height*1.0)

line_pt_start = ( int(width * 0.3), int(height *0.6))
line_pt_end = (int(width * 0.7), int(height *0.6))

line_pt_height = ( int(width * 0.5), int(height *0.55))
line_pt_width = (int(width * 0.5), int(height *0.65))
...
image_lane = cv2.line(image_lane, line_pt_start, line_pt_end, (255, 0, 0), 1)
image_lane = cv2.line(image_lane, line_pt_height, line_pt_width, (255, 0, 0), 1)
